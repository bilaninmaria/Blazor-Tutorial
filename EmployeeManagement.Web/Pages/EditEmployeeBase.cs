...
namespace EmployeeManagement.Web.Pages
{
    public class EditEmployeeBase : ComponentBase
    {
        ...
        [Inject]
        private IAuthorizationService IAuthorizationService { get; set; } 
        [Inject]
        ...
        protected async override Task OnInitializedAsync() // lifecycle method 
        {
